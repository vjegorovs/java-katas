...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(e -> e.getAge()).sorted();
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (cAge1, cAge2) -> cAge2.compareTo(cAge1);
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().flatMap(getItemStream).map(e -> e.getName());

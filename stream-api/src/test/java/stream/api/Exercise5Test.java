...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void oldestCustomer() {
         ...
         */
        Optional<Customer> oldestCustomer = customerList.stream().collect(Collectors.maxBy((c1,c2)-> c1.getAge() - c2.getAge()));
    ...
    public void ageDistribution() {
         ...
         */
        //Map<Integer, Long> ageDistribution = customerList.stream().collect(Collectors.group);
